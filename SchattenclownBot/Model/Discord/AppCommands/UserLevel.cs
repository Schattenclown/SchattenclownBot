...
internal class UserLevel : ApplicationCommandsModule
{
   ...
   public static async Task MyLevelAsync(InteractionContext interactionContext)
   {
      ...
      string urlString = "https://quickchart.io/chart?w=1000&h=180&bkg=%232f3136&c={\"type\":\"horizontalBar\",\"data\":{\"datasets\":[{\"barPercentage\":1,\"categoryPercentage\":1,\"data\":[" + $"{calculatedXpOverCurrentLevel}" + "],\"type\":\"horizontalBar\",\"label\":\"XP\",\"borderColor\":\"%23e100ff\",\"backgroundColor\":\"rgba(80,0,121,0.4)\",\"borderWidth\":3,\"xAxisID\":\"X1\",},{\"barPercentage\":1,\"categoryPercentage\":1,\"data\":[" + $"{calculatedXpSpanToReachNextLevel}" +
                         ...
                         $"{calculatedXpSpanToReachNextLevel}" + "}}],\"yAxes\":[{\"stacked\":true,\"time\":{\"displayFormats\":{}}}]},\"plugins\":{\"datalabels\":{\"anchor\":\"end\",\"backgroundColor\":\"%23e241ff\",\"borderColor\":\"%23e241ff\",\"borderRadius\":6,\"padding\":4,\"color\":\"%23282828\",\"font\":{\"family\":\"sans-serif\",\"size\":30,\"style\":\"normal\"}},},}}";
