...
internal class Alarm : ApplicationCommandsModule
{
	...
	/// <returns></returns>
	[SlashCommand("SetAlarm" + Bot.IS_DEV_BOT, "Set an alarm for a specific time!")]
	...
	/// <returns></returns>
	[SlashCommand("MyAlarms" + Bot.IS_DEV_BOT, "Look up your alarms!")]
	public static async Task AlarmClockLookup(InteractionContext interactionContext)
	{
		...
		var botAlarmClockList = DbBotAlarmClocks.ReadAll();
