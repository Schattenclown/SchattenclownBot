...
namespace SchattenclownBot.Integrations.Discord.ApplicationCommands
{
    public class UserLevel : ApplicationCommandsModule
    {
        ...
        public async Task MyLevelAsync(InteractionContext interactionContext)
        {
            ...
            string urlString = "https://quickchart.io/chart?w=1000&h=180&bkg=%232f3136&c={\"type\":\"horizontalBar\",\"data\":{\"datasets\":[{\"barPercentage\":1,\"categoryPercentage\":1,\"data\":[" + $"{calculatedXpOverCurrentLevel}" + "],\"type\":\"horizontalBar\",\"label\":\"XP\",\"borderColor\":\"%23e100ff\",\"backgroundColor\":\"rgba(80,0,121,0.4)\",\"borderWidth\":3,\"xAxisID\":\"X1\",},{\"barPercentage\":1,\"categoryPercentage\":1,\"data\":[" + $"{calculatedXpSpanToReachNextLevel}" + "],\"type\":\"horizontalBar\",\"label\":\"XPNeeded\",\"borderColor\":\"%23e100ff\",\"backgroundColor\":\"rgba(58,0,179,0.2)\",\"borderWidth\":3,\"xAxisID\":\"X1\"}],\"labels\":[]},\"options\":{\"title\":{\"display\":false,\"position\":\"top\",\"fontSize\":25,\"fontFamily\":\"sans-serif\",\"fontColor\":\"%23ff00ff\",\"fontStyle\":\"bold\",\"padding\":10,\"lineHeight\":1.2,\"text\":\"Titlebehere\"},\"layout\":{\"padding\":{\"left\":30,\"right\":30,\"top\":30,\"bottom\":10}},\"legend\":{\"display\":false},\"scales\":{\"xAxes\":[{\"id\":\"X1\",\"display\":true,\"position\":\"bottom\",\"type\":\"linear\",\"stacked\":false,\"time\":{},\"distribution\":\"linear\",\"gridLines\":{\"color\":\"%23e100ff\",\"lineWidth\":4,\"drawBorder\":true,\"drawOnChartArea\":true,\"drawTicks\":true,\"tickMarkLength\":10,\"zeroLineWidth\":4,\"zeroLineColor\":\"%23e100ff\"},\"ticks\":{\"display\":true,\"fontSize\":30,\"fontFamily\":\"sans-serif\",\"fontColor\":\"%23ff00ff\",\"fontStyle\":\"bold\",\"padding\":0,\"suggestedMin\":0,\"suggestedMax\":0,\"stepSize\":1000000,\"minRotation\":0,\"maxRotation\":50,\"mirror\":false,\"reverse\":false,\"max\":" + $"{calculatedXpSpanToReachNextLevel}" + "}}],\"yAxes\":[{\"stacked\":true,\"time\":{\"displayFormats\":{}}}]},\"plugins\":{\"datalabels\":{\"anchor\":\"end\",\"backgroundColor\":\"%23e241ff\",\"borderColor\":\"%23e241ff\",\"borderRadius\":6,\"padding\":4,\"color\":\"%23282828\",\"font\":{\"family\":\"sans-serif\",\"size\":30,\"style\":\"normal\"}},},}}";
        ...
        public async Task LeaderboardAsync(InteractionContext interactionContext)
        {
            ...
            List<DiscordMember> discordMemberList = DiscordBot.DiscordClient.GetGuildAsync(interactionContext.Guild.Id).Result.Members.Values.ToList();
