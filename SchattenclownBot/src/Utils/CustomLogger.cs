...
namespace SchattenclownBot.Utils
{
    ...
    {
        public static readonly List<Logger> Loggers = new();
        ...
        public void Information(string message, ConsoleColor consoleColor, [CallerMemberName] string methodName = "")
        {
            ...
            callerNameSpace = new StringCutter().RemoveAfter(callerNameSpace, "+", 0);
        ...
        public void Debug(string message, ConsoleColor consoleColor, [CallerMemberName] string methodName = "")
        {
            string callerNameSpace = new StackTrace().GetFrame(1)?.GetMethod()?.ReflectedType?.UnderlyingSystemType.ReflectedType?.FullName ?? new StackTrace().GetFrame(1)?.GetMethod()?.ReflectedType?.FullName ?? "Unknown";
            callerNameSpace = new StringCutter().RemoveAfter(callerNameSpace, "+", 0);
            string callerNameSpaceMethodName = $"[{callerNameSpace}.{methodName}]: ";
        ...
        public void Error(Exception exception, [CallerMemberName] string methodName = "")
        {
            string callerNameSpace = new StackTrace().GetFrame(1)?.GetMethod()?.ReflectedType?.UnderlyingSystemType.ReflectedType?.FullName ?? new StackTrace().GetFrame(1)?.GetMethod()?.ReflectedType?.FullName ?? "Unknown";
            callerNameSpace = new StringCutter().RemoveAfter(callerNameSpace, "+", 0);
        ...
        public void Error(string objectInfo, Exception exception, [CallerMemberName] string methodName = "")
        {
            string callerNameSpace = new StackTrace().GetFrame(1)?.GetMethod()?.ReflectedType?.UnderlyingSystemType.ReflectedType?.FullName ?? new StackTrace().GetFrame(1)?.GetMethod()?.ReflectedType?.FullName ?? "Unknown";
            callerNameSpace = new StringCutter().RemoveAfter(callerNameSpace, "+", 0);
